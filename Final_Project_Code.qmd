...
We made a model to predict the mean Happiness Score based on the log of the mean Daily Income for each country, from the years 2005 to 2023. 
...
We predict that a country with a log of their mean daily income equal to 0 will have a mean happiness score of 31.59 between the years 2005 to 2023.

If we multiply the mean Daily Income by e, we predict a chnage of 8.73 in the mean Happiness Score. 
...
=======
  remove_column(c(4:10))

model %>%
  augment()
  
>>>>>>> 54d563e94674c4dd6f5adc843be5e400a8c822ef
```
