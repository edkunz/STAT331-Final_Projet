...
How this relationship (from #1) has changed over time using an animated plot. The gganimate package makes it easy to animate ggplot2 graphics. This websiteLinks to an external site. has a great Getting StartedLinks to an external site. tutorial on how to make animated visualizations.
...
The variance in the response values. (A) The variance in the fitted values from your regression model. (B) The variance in the residuals from your regression model. The model R2 (B / A) You should format your table nicely using either the kable and kableExtra or gt
